      * ===============================================================         
      * The user invokes this transaction (called MB27) via:                    
      *   MB27 <VERB>                                                           
      *                                                                         
      * Where:                                                                  
      *   <VERB> = CRE|UPD|DEL                                                  
      ...
      *                                                                         
      * CREate                                                                  
      *  Invoked via MB27 CRE <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
      ...
      *                                                                         
      *  Example:                                                               
      *   MB27 CRE BRONZE 10 4                                                  
      *                                                                         
      * UPDate                                                                  
      *  Invoked via MB27 UPD <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
