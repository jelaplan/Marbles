      * ===============================================================         
      * The user invokes this transaction (called MB22) via:                    
      *   MB22 <VERB>                                                           
      *                                                                         
      * Where:                                                                  
      *   <VERB> = CRE|UPD|DEL                                                  
      ...
      *                                                                         
      * CREate                                                                  
      *  Invoked via MB22 CRE <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
      ...
      *                                                                         
      * UPDate                                                                  
      *  Invoked via MB22 UPD <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
