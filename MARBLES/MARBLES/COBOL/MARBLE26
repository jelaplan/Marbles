      * ===============================================================         
      * The user invokes this transaction (called MB26) via:                    
      *   MB26 <VERB>                                                           
      *                                                                         
      * Where:                                                                  
      *   <VERB> = CRE|UPD|DEL                                                  
      ...
      *                                                                         
      * CREate                                                                  
      *  Invoked via MB26 CRE <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
      ...
      *                                                                         
      *  Example:                                                               
      *   MB26 CRE SILVER 10 4                                                  
      *                                                                         
      * UPDate                                                                  
      *  Invoked via MB26 UPD <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
