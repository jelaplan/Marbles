      * ===============================================================         
      * The user invokes this transaction (called MB06) via:                    
      *   MB06 <VERB>                                                           
      *                                                                         
      * Where:                                                                  
      *   <VERB> = CRE|UPD|DEL                                                  
      ...
      *                                                                         
      * CREate                                                                  
      *  Invoked via MB06 CRE <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
      ...
      *                                                                         
      *  Example:                                                               
      *   MB06 CRE INDIGO 10 4                                                  
      *                                                                         
      * UPDate                                                                  
      *  Invoked via MB06 UPD <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
