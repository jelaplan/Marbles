      * ===============================================================         
      * The user invokes this transaction (called MB18) via:                    
      *   MB18 <VERB>                                                           
      *                                                                         
      * Where:                                                                  
      *   <VERB> = CRE|UPD|DEL                                                  
      ...
      *                                                                         
      * CREate                                                                  
      *  Invoked via MB18 CRE <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
      ...
      *                                                                         
      *  Example:                                                               
      *   MB18 CRE MAROON 10 4                                                  
      *                                                                         
      * UPDate                                                                  
      *  Invoked via MB18 UPD <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
