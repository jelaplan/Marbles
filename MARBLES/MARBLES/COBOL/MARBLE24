      * ===============================================================         
      * The user invokes this transaction (called MB24) via:                    
      *   MB24 <VERB>                                                           
      *                                                                         
      * Where:                                                                  
      *   <VERB> = CRE|UPD|DEL                                                  
      ...
      *                                                                         
      * CREate                                                                  
      *  Invoked via MB24 CRE <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
      ...
      *                                                                         
      *  Example:                                                               
      *   MB24 CRE PURPLE 10 4                                                  
      *                                                                         
      * UPDate                                                                  
      *  Invoked via MB24 UPD <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
