      * ===============================================================         
      * The user invokes this transaction (called MB14) via:                    
      *   MB14 <VERB>                                                           
      *                                                                         
      * Where:                                                                  
      *   <VERB> = CRE|UPD|DEL                                                  
      ...
      *                                                                         
      * CREate                                                                  
      *  Invoked via MB14 CRE <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
      ...
      *                                                                         
      * UPDate                                                                  
      *  Invoked via MB14 UPD <COLOR> <INVENTORY> <COST>                        
      *                                                                         
      *  Where:                                                                 
